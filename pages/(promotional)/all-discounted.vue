<template>
  ...
  <Head>
    <Title> Discounts - Save Big on Quality Pieces!</Title>
  </Head>
  <div class="q-gutter-y-md" style="margin-top: 48px">
    <div v-if="page_banner" class="flex justify-around items-center bg-grey-2">
    ...
    <q-card v-else square flat>
      <NuxtImg loading="lazy" format="webp" quality="50" class="fit" height="60" :draggable="false"
        placeholder="/placeholder.gif" src="/pages/all-discounted-page-m.webp" alt="page-banner" title="page-banner" />
    </q-card>
    <!-- Product List -->
...
const show = ref(true);
const title = ref("All Discounted Products");
